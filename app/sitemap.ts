...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPaths = [
    ...
    { path: "/docs/hospital", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/docs/hospital/patients", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/docs/hospital/opd", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/docs/hospital/ipd", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/docs/hospital/laboratory", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/docs/hospital/ot", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/docs/hospital/pharmacy", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/docs/hospital/billing", priority: 0.7, changeFrequency: "monthly" as const },
