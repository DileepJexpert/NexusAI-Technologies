...
const messages = [
  {
    id: 1,
    from: "user" as const,
    text: "Hi, I need the right product for my operations team.",
  },
  {
    id: 2,
    from: "bot" as const,
    text: "Welcome to Katixo.\nI can help match you to the right product, workflow or team.",
  },
  {
    id: 3,
    from: "user" as const,
    text: "We need faster lead handling and customer follow-up.",
  },
  {
    id: 4,
    from: "bot" as const,
    text: "Perfect.\nI'll narrow that to the best-fit Katixo product and next rollout step.",
  },
];
    ...
    >
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <div className="truncate text-sm font-semibold text-white">Katixo Assistant</div>
          <div className="flex items-center gap-1.5">
            <span className="h-2 w-2 rounded-full bg-green-400" />
            <span className="text-[11px] text-white/70">online · concierge</span>
          </div>
        </div>
      </div>
